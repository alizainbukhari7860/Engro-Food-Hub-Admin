...
<body class="fix-header">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div style="background-color: #E4FACC" class="white-box">
                                    <h3 class="box-title">Snacks Menu</h3>
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT item.id,item.name,Price,PreparationTime,Calories FROM `item` join categories on item.Category=categories.ID JOIN menu on menu.ID=categories.Menu where menu.Name like '%Snacks%' and `isDelete`=0";
    ...
    <?php
            ...
            $_SESSION["editsnacks"] = $edit;
            header("Location: ./editsnack.php");
        }
    }
