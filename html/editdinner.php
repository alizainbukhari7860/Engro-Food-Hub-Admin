                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div style="background-color: #E4FACC" class="white-box">
                                    ...
                                    <div style="background-color: #E4FACC" class="white-box">
                                        <?php
                                        $abc = $_SESSION['editdinner'];
                                        $sql1 = "SELECT item.id,item.name,Price,PreparationTime,menu.ID as menuid,categories.ID as catid FROM `item` join categories on item.Category=categories.ID JOIN menu on menu.ID=categories.Menu where menu.Name like '%Dinner%' and item.ID=" . $abc;
